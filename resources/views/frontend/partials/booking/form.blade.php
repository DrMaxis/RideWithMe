		...
		<form class="online-booking-form row">
				...
				<div class="booking-details-container">
					...
					<div class="form-group col-md-6 col-sm-12 col-xs-12">
						...
						<div id="datepicker" class="input-group">
							<input class="form-control" data-format="MM/dd/yyyy HH:mm:ss PP" id="request_date" name="request_date" value="{{session()->get('rideRequestSessionData')['request_date']}}" placeholder="DD/MM/YYYY" />
							<span class="add-on">
					...
					<div class="form-group col-md-6 col-sm-12 col-xs-12">
						<input type="checkbox"><span>Allow Other Users With The Same Destination To Join This Ride & Split The Fare</span>
				...
				<div class="booking-submit">
					...
					<div class="form-group col-md-12 col-sm-12 col-xs-12">
							...
							<input type="checkbox" value="true" class="accept-terms" name="accepted_terms" {{ !old('accepted_terms') ?: 'checked' }}><span><a id="fadeLink" class="accept-terms" {{-- href="{{route('policy')}}" --}}>I understand and agree with the Terms of Service and Cancellation /
