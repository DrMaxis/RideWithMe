                    ...
                    <div class="col-md-4">
                        <form name="book-taxi" class="book-taxi-form" action="{{ route('frontend.ride.session.request') }}" method="POST">
                            ...
                            <div class="form-group col-md-6 col-sm-6">
                                ...
                                <input type="text" class="form-control phone_number" id="phone_number" name="phone_number" value="{{ $logged_in_user->phone_number ?? old('phone_number')}}" placeholder="Enter Phone Number" />
