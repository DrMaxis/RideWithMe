    ...
    <div class="row">
        <div class="col">
            <div class="form-group mb-0 clearfix">
                ...
                <span style="float:right"> You Currently have {{count($logged_in_user->cars)}} Car(s) Connected To Your Account  <a href="{{route('frontend.user.account.cars.index')}}">View Them Here</a> </span>
            </div><!--form-group-->
        </div><!--col-->
    </div><!--row-->
{{ html()->closeModelForm() }}
